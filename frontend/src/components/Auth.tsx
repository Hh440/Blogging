...
import { SignupType } from "blogger_common"
    ...
    return <div className="h-screen flex justify-center flex-col">
              <div className="flex justify-center">
                <div> 
                    ...
                    <div className="pt-4" >
                       { type==="signup" ?<LabelledInput label="Name" placeholder="Hemani" onchange={(e)=>{
                            setPostInputs(c=>({
                                ...c,
                                name:e.target.value
                            }))
                        ...
                        <LabelledInput label="Username" placeholder="hh921@gmail.com" onchange={(e)=>{
                            setPostInputs(c=>({
                                ...c,
                        ...
                        <LabelledInput label="Password" type={"password"} placeholder="UH12&!@#qr" onchange={(e)=>{
                            setPostInputs(c=>({
                                ...c,
